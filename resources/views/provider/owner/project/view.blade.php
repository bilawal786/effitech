                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">
                                    @if($site->client_id)
                                        ...
                                        <b>Catégorie</b>: {{empty($site->client->category->name) ? 'Supprimé' : $site->client->category->name}}<br>
                                        <b>Sous catégorie</b>: {{empty($site->client->subcategory->name) ? 'Supprimé' : $site->client->subcategory->name}}<br>
                                        <b>Description</b>: {{$site->client->notes}}<br>
                                    @else
                                        <b>Supreme</b>
                                    @endif
                                </p>
