                                ...
                                <div class="card-body">
                                    <div class="media align-items-center">
                                        ...
                                        <div class="media-body">
                                            <p class="fs-14 mb-2">Chantier total</p>
                                            <span class="title text-black font-w600">{{$sites->count()}}</span>
                                        </div>
                                    </div>
                            ...
                            <div class="card avtivity-card">
                                <div class="card-body">
                                    <div class="media align-items-center">
                                        ...
                                        <div class="media-body">
                                            <p class="fs-14 mb-2">Total des problèmes</p>
                                            <span class="title text-black font-w600">{{$problems->count()}}</span>
                                        </div>
                                    </div>
                                    <div class="progress" style="height:5px;">
